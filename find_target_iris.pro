...
if 1 then begin
  for i=0, n_elements(ar_num)-1 do begin
    str = 'https://www.lmsal.com/hek/hcr?cmd=search-events3&outputformat=json&'+$
          'startTime=2013-07-20T00:00&stopTime=2022-07-15T00:00&target=AR&maxcadMeanAsrun=15&maxrasterStepsize=0&'+$
          'hasData=true&hideMostLimbScans=true&obsDesc='+string(ar_num[i], f='(i0)')+'&limit=200'
