  ...
  if ~file_exist(out_dir+'/No_results') then begin 
    ...
    for i=0, n_elements(sg_files)-1 do begin ; raster file no
      ...
      if i eq 0 then begin
        ...
        for ii=0, nwin-1 do wave_list[ii] = dd->getlam(ii)
      endif
        ...
        if count ne 0 then begin
          ...
          for k=0, n_elements(real_ind1)-1 do begin
            for l=0, nwin-1 do begin
              ...
              data_list[l] = [[data_list[l]], [dd->descale_array(dum)]]
            endfor
            xpos = sg_xp[j]
            ...
            sji_value = [sji_value, interpolate(sji_img, sji_xpix, sji_ypix)]
    ...
    if n_elements(data_list[0]) ne 0 then begin
      eout = {data_list:data_list, wave_list:wave_list, line_id:line_id, $ 
              sg_ind:sg_ind, sg_phy:sg_phy, sji_ind:sji_ind, sji_value:sji_value, $
              aia_ind:aia_ind, aia_phy:aia_phy, aia1600_ind:aia1600_ind, aia193_value:aia193_value, $
      ...
      print, 'No results.'
      save, sg_spec, filename=out_dir+'/No_results'
    endelse
  endif 
endelse
;stop
